...
class Card{
    ...
    addEvents(){
        ...
        if(!this.playerTurn){
           playerField = document.querySelector('.enemy-field')
           numberOfCardsInBattlefield = playerField.querySelectorAll(".card").length
        }
        ...
        this.HTML.addEventListener("dragstart", ()=>{
            ...
            if(this.HTML.classList.contains("enemy") || this.HTML.classList.contains("player") && this.HTML.classList.contains("card")){
        ...
        this.HTML.addEventListener("dragend", ()=>{
            if(this.HTML.classList.contains("player") || this.HTML.classList.contains("enemy") && this.HTML.classList.contains("card")){
